        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="/bloodprofileavrist/cetakpdf" target="_blank">Blood Profile
                                Avrist</a></li>
                        <li><a class="dropdown-item" href="#" target="_blank">Approval Letter</a></li>
                        <li><a class="dropdown-item" href="#" target="_blank">Decline Letter Untuk Member</a></li>
                        <li><a class="dropdown-item" href="#" target="_blank">Decline Letter Untuk Perusahaan</a>
                        </li>
                        <li><a class="dropdown-item" href="#" target="_blank">Follow UP Letter Member</a></li>
                        <li><a class="dropdown-item" href="#" target="_blank">Follow UP Letter Perusahaan</a></li>
                        <li><a class="dropdown-item" href="#" target="_blank">Innitial Letter Untuk Perusahaan</a>
                        </li>
                        <li><a class="dropdown-item" href="#" target="_blank">Innitial Letter Untuk Member</a>
                        </li>
                        <li><a class="dropdown-item" href="#" target="_blank">LPK Avrist Dewasa</a></li>
                        <li><a class="dropdown-item" href="#" target="_blank">Rate UP Letter (surat penawaran
                                ekstra premi)</a>
                        </li>
                        <li><a class="dropdown-item" href="#" target="_blank">Surat Penghantar Medis</a>
                        </li>
                        <li><a class="dropdown-item" href="#" target="_blank">Limit Letter</a>
                        </li>
                        <li><a class="dropdown-item" href="#" target="_blank">HDF Form</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="#" target="_blank">Reminder Notice Billing</a></li>
                        <li><a class="dropdown-item" href="#" target="_blank">Report AGEING - Present BOD</a>
                        </li>
                        <li class="dropdown-submenu">
                            <a class="dropdown-item dropdown-toggle" href="#" id="navbarDropdownMenuLink"
                        ...
                        <li><a class="dropdown-item" href="#" target="_blank">Summary Report Ageing - Present
                                BOD</a></li>
                        <li class="dropdown-submenu">
                            <a class="dropdown-item dropdown-toggle" href="#" id="navbarDropdownMenuLink"
